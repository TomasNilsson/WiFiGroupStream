...
import com.teamadhoc.wifigroupstream.DeviceListFragment.DeviceActionListener;
...
//                        }
    ...
    public void onConnectionInfoAvailable(final WifiP2pInfo info) {
        ...
        if (info.groupFormed && info.isGroupOwner) {
            // Tasks that are specific to the group owner.
            // Create a server thread which accepts incoming connections.
